...
All this denotes is that to find the sum of the roots of a quadratic, we need to the $x$ coefficient, $b$ and the $x^2$ coefficient, $a$, and evaluate $\frac{-b}{a}$. So in our case, the answer would be $37293/26238$
